...
<body>
  ...
  <section class="about-me" id="profil">
    ...
    <div class="info-personelle">
      <div class="list">
        <p><span> Anniversaire :</span>  17 Avril 1994</p>
      </div>
      <div class="list">
        <p><span> Email:</span>  adrien.pago@gmail.com</p>
      </div>
      <div class="list">
        <p><span> Age:</span>  28 ans</p>
      </div>
    </div>
    <!--Réseaux sociaux-->
    <div class="network">
      <p>Vous pouvez aussi me concater par <span>email</span>, ou bien retrouver mon profil sur <span>Linkedin </span>  </p>
    </div> 
    ...
    <div class="tableau-skill" id="tableau-section">
      <table>
        ...
        <tbody>
          ...
          <tr data-id="Support">
            <td>Réponse aux incidents et aux demandes d’assistance et d’évolution</td>
            <td>UNITÉ U4 Support et mise à disposition de services informatiques</td>
          </tr>
          <tr data-id="Support">
            <td>Travail en mode projet</td>
            <td>UNITÉ U4 Support et mise à disposition de services informatiques</td>
            <td><a href ="./HTML/AS.html" target="_blank">Projet-AS</a> </td>
          </tr>
          <tr data-id="Support">
            <td>Mise à disposition des utilisateurs d’un service informatique</td>
            <td>UNITÉ U4 Support et mise à disposition de services informatiques</td>
            <td><a href ="./HTML/AS.html" target="_blank">Projet-AS</a> </td>
          </tr>
          <tr data-id="Support">
            <td>Organisation de son développement professionnel</td>
            <td>UNITÉ U4 Support et mise à disposition de services informatiques</td>
    ...
    <div class="portfolio-gallery">
      ...
      <div class="item" data-ids="logiciel">
        <div class="inner">
          ...
          <h4>Développer une application pour les agent du département qui traitre les aides sociales</h4>
        </div>
      </div>
      ...
      <div class="item" data-ids="web">
        <div class="inner">
          <img src="image/Logo/logo-projet.jpg" data-page="./HTML/GDIN.html">
          <h4>Apporter des modification sur une application déjà créé et la maintenir à jours</h4>
        </div>
      </div>
      <div class="item" data-ids="web">
        <div class="inner">
...
<section class="veille" >  
  <section class="annonce-veille" id="veille">  <!--Annonce veuille-->
